...
public class Home_BG  extends LinearLayout {
    ...
    public Home_BG(Context context) {
        this(context, null);
    }

    public Home_BG(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Home_BG(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
